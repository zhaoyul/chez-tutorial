...
;; ========================================
;; Helper functions for demonstrate-fixnum-ops
;; ========================================
...
;; ========================================
;; Helper functions for demonstrate-vector-vs-list
;; ========================================
...
;; ========================================
;; Helper functions for demonstrate-tail-recursion
;; ========================================
...
;; ========================================
;; Helper functions for demonstrate-inlining
;; ========================================

;; 普通函数
(define (square x) (* x x))

;; 内联版本（Chez Scheme 会自动内联小函数）
(define (square-inline x) (* x x))
...
;; ========================================
;; Helper functions for demonstrate-memoization
;; ========================================
...
;; ========================================
;; Helper functions for demonstrate-local-caching
;; ========================================
...
;; ========================================
;; Helper functions for demonstrate-preallocation
;; ========================================
...
;; ========================================
;; Helper functions for demonstrate-string-ops
;; ========================================
...
;; 2. 向量 vs 列表
(define test-list-demo
  (let loop ([i 0] [acc '()])
    (if (>= i 10000)
        acc
        (loop (+ i 1) (cons i acc)))))

(define test-vector-demo (make-vector 10000 0))
(do ([i 0 (+ i 1)])
    ((>= i 10000))
  (vector-set! test-vector-demo i i))
...
(define (demonstrate-vector-vs-list)
  ...
  (display "  列表版本: ")
  (time (sum-list test-list-demo))
  (display "  向量版本: ")
  (time (sum-vector test-vector-demo))
...
(define (demonstrate-string-ops)
  ...
  (display "  多次拼接: ")
  (time (concat-multiple-slow test-strings-demo))
  (display "  一次拼接: ")
  (time (concat-multiple-fast test-strings-demo))
